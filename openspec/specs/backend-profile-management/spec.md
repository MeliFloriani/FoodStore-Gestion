# backend-profile-management Specification

## Purpose
Backend profile management capability. Introduced in Change 13 (customer-profile-management). Provides schemas, services, and endpoints for updating user profile data and changing passwords.
