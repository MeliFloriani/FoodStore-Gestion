...
## Purpose
Structlog-based structured logging with JSON output in production and dev-friendly format in development. Introduced in Change 02 (backend-core-foundation).
