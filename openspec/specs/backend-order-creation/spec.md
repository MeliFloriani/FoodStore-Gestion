...
> This section adds a clarifying cross-reference to the archived Change 17 spec. No existing requirement is modified. The purpose is to establish ownership boundaries between Change 17 (initial history row) and Change 18 (all subsequent history rows).
