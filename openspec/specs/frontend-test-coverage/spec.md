...
## Purpose
Code coverage measurement and enforcement for the frontend (React/TypeScript/Vite) using @vitest/coverage-v8. Introduced in Change 25 (quality-assurance-tests-and-coverage).
